...
import { useGoogleReCaptcha } from "react-google-recaptcha-v3"; // ✅ v3 import
...
const CareerForm = () => {
  ...
  // ✅ recaptchaToken state, recaptchaRef, onRecaptchaChange — sab hata diye
  ...
  const onSubmit = async (data) => {
    ...
    // ✅ v3 token yahan generate hoga
    if (!executeRecaptcha) {
      Swal.fire({ title: "ReCAPTCHA not ready", icon: "error" });
    ...
    try {
      if (token && recaptchaToken) {
        ...
        if (res.status === 200) {
          ...
          setFileName("");
          // ✅ recaptchaRef.current.reset() aur setRecaptchaToken(null) hata diye
        }
      }
    } catch (err) {
    ...
    <div className="contact-form" data-aos="fade-up" data-aos-delay="300">
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="row mb-n6">
            ...
            <input
              ...
              {...register("experienceyear", {
                ...
                validate: (value) => {
                  ...
                  if (years === 0 && months === 0) return "Enter experience like 1.5 years or 1y 6m";
                  if (years > 20) return "Years cannot exceed 20";
                  if (months > 11) return "Months must be between 0–11";
                  return true;
                },
              })}
            />
            ...
            <input
              ...
              {...register("selectjoining", {
                ...
                validate: (value) => {
                  ...
                  if (num < 0 || num > 99) return "Joining days must be between 0 and 99.";
                  return true;
                },
              })}
            />
              ...
              {...register("uploadresume", {
                ...
                validate: {
                  isValidFile: () => {
                    ...
                    return allowedTypes.includes(file.type) || "Only PDF, DOC or DOCX files are allowed.";
                  },
                },
              })}
            />
          ...
          {/* ✅ ReCAPTCHA component hata diya — v3 me checkbox nahi hota */}
